...
@Component({
  selector: 'app-admin-patient-clinical-records',
  templateUrl: './admin-patient-clinical-records.component.html',
  styleUrls: ['./admin-patient-clinical-records.component.css']
})
export class AdminPatientClinicalRecordsComponent implements OnInit  {
