...
@Component({
  selector: 'app-admin-appointments-grid',
  templateUrl: './admin-appointments-grid.component.html',
  styleUrls: ['./admin-appointments-grid.component.css']
})
export class AdminAppointmentsGridComponent implements OnInit {
